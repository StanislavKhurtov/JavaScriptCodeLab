...
//		inp2 = +document.querySelector('.i-32').value;
//
//	if (inp1 > inp2) {
//		document.querySelector('.out-3').innerHTML = inp1;
//	} else {
//		document.querySelector('.out-3').innerHTML = inp2;
//	}
//}
//
...
//	} else if (inpt > 32 && inpt <= 43) {
//		document.querySelector('.out-9').innerHTML = '2';
//	} else if (inpt > 43 && inpt <= 64) {
...
//		input2 = document.querySelector('.i-142').value,
//		select = document.querySelector('.s-143').value;
//
//		if (select === '+') {
...
function f15() {
	let sel1 = +document.querySelector('.s-151').value,
		sel2 = +document.querySelector('.s-152').value,
		sel3 = document.querySelector('.s-153').value;
	let res;
	if (sel3 == '&&') {
		res = sel1 && sel2;
	} else {
