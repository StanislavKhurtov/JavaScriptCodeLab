...
// Ответ: так как мы добавляем массив, а как мы значем массив имеет ссылочный тип, то в набор записываются два массива, хотя визуально они похожи, но имеют разыне ссылки.
