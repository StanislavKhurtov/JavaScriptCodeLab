...
/*document.querySelector('#three').innerHTML = "Hello World";*/
...
/*document.querySelector('#three').innerHTML = "<h3>заголовок</h3> ";*/
...
/*document.querySelector('#one').innerHTML += "<h3>заголовок</h3><p>Текст под заголовком</p> ";*/
...
//let a = document.querySelector('#one').innerHTML = 3.1415;
...
//let div1 = document.querySelector('#one').innerHTML = '<img src="https://cdn4.iconfinder.com/data/icons/food-and-drink-flat-gradient/32/cone_ice_cream_food_drink_sweet-512.png" alt="">';
...
/*let z1 = 6,
	...
	document.querySelector(".four").innerHTML = z1 * z2;*/
...
/*let y1 = 6, y2 = 3;
	...
	document.querySelector(".four").innerHTML = y1 / y2;*/
...
document.querySelector(".four").innerHTML = x1 + x2;
*/

// Task 17.
// Создайте div с классом test-1. Получите его в переменную d1. Выведите эту переменную в консоль. Изучите вывод.

//let d1 = document.getElementsByClassName("four");  // Получили псевдоколлекцию
//console.log(d1);
...
//let s3 = document.querySelector(".four"); 
//let s4 = document.querySelector(".five");
//
//console.log(s3);
//
//s3 = s4;
