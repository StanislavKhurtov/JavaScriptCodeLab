...
function f7() {
	let inp = document.querySelector('.i-7'),
		div71 = document.querySelector('.out-71'),
		div72 = document.querySelector('.out-72');

	div71.textContent = inp.value;
...
function f81() {
	let inp = document.querySelector('.i-81'),
		div81 = document.querySelector('.out-81');
	div81.textContent = inp.value;
}
...
function f12() {
	let inp = document.querySelector('.i-12'),
		div = document.querySelector('.out-12');
...
function f13() {
	let inp = document.querySelector('.i-13'),
		div = document.querySelector('.out-13');
...
function f14() {
	let inp = document.querySelector('.t-14'),
		div = document.querySelector('.out-14');
...
function f15() {
	let inp = document.querySelector('.i-15'),
		...
		div = document.querySelector('.out-15');

	div.textContent = text.value = inp.value;
...
function f16() {
	...
	let select = document.querySelector('.s-16'),
		div = document.querySelector('.out-16');
...
function f17() {
	let select = document.querySelector('.s-17'),
		div = document.querySelector('.out-17');
	div.textContent = select.value;
...
function f19() {
	...
	document.querySelector('.out-19').innerHTML = form.elements.i191.value + " " + form.elements.i192.value;
