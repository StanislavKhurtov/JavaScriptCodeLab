...
! НЕ ПРАВИЛЬНО 1. Общее пространство, которое всегда ограничено четырьмя grid-линиями - это...
...
!НЕ ПРАВИЛЬНО 2. Как правильно указать grid-gap?
...
! НЕ ПРАИВЛЬНО 3. Выберите верные утверждения, относительно fr:
